...
export const NAME = 'Shahzad Sipra'
...
export const config: Config = {
  ...
  seo: {
    ...
    canonical: 'https://techdigi.dev',
    openGraph: {
      type: 'website',
      locale: 'en_US',
      url: 'https://techdigi.dev',
      title: `${NAME} // Full-Stack Software Developer`,
      description:
        'I build things with my mouse and keyboard. Welcome to my software developer portfolio.',
      ...
      images: [
        {
          url: 'https://techdigi.dev/img/banner.png',
          width: 1200,
          height: 630,
          alt: 'techdigi banner',
        },
    ...
    languageAlternates: [
      { hrefLang: 'en', href: 'https://techdigi.dev' },
      { hrefLang: 'fr', href: 'https://techdigi.dev/#en' },
    ],
    additionalMetaTags: [
  ...
  email: 'shahzadsipra06@gmail.com',
  email_link: 'mailto:shahzadsipra06@gmail.com',
  github: 'https://github.com/shahzadsipra',
  linkedin: 'https://www.linkedin.com/in/shahzadsipra/',
  posthog: {
    events: {
